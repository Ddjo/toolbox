...
export const CHAT_ROOM_GET_PREVIOUS_MESSAGES_FOR_CHATROOM = 'get-previous-messages-for-chat-room';
export const CHAT_ROOM_GET_OR_CREATE_CHAT_ROOM = 'create-chat-room';
