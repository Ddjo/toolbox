import { CHAT_ROOM_GET_OR_CREATE_CHAT_ROOM, CHAT_ROOM_DELETE_CHAT_ROOM, CHAT_ROOM_GET_ALL_CHAT_ROOMS_FOR_USER, CHAT_ROOM_UPDATE_CHAT_ROOM } from '@constants';
...
export class RoomsController {
  ...
  @MessagePattern(CHAT_ROOM_GET_OR_CREATE_CHAT_ROOM)
  async getOrCreate(@Payload() createChatRoomDto: CreateChatRoomDto) {
    return this.roomsService.getOrCreate(createChatRoomDto);
  }
